---
title: "Spatial data <br/>& GIS tools in R"
subtitle: "Lecture 22"
...
::: {.aside}
EPSG (originally European Petroleum Survey Group) is a public registry of coordinate reference systems and related data 
:::
...
plot(ak_shift, axes=TRUE, col="black", border=NA, xlim=c(-190, -130), graticule = TRUE)
points(c(-360+179.776,-179.146), c(51.952,51.273),col='red')
abline(v=-180,col='blue',lty=2)

plot(ak_shift, col="black", border=NA, xlim=c(-185, -170), ylim=c(50, 55), graticule = TRUE)
points(c(-360+179.776,-179.146), c(51.952,51.273),col='red')
abline(v=-180,col='blue',lty=2)
box()
```
