...
As you have likely noticed, the individual characters in a string (element of a character vector) cannot be directly accessed. Base R provides a number helpful functions for pattern matching and manipulation of these objects:
